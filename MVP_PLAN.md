...
| 2026-09-13 | Post-MVP  | Polished profile and wishlist form alignment: helper text no longer stretches neighboring controls, profile actions are inline with a larger primary Save action on desktop and stack at equal full width on phones; automated geometry checks pass in desktop Chromium, Android Chrome, and iPhone Safari                                                   | Continue invited-collector validation and triage reported issues       |
