...
| 2026-09-13 | Post-MVP  | Fixed album artwork disappearing during catalogue quick-add by carrying the already-displayed, entity-validated Cover Art Archive selection through collection and wishlist forms instead of depending on a second cover request; 232 app tests, build, and the authenticated catalogue-to-wishlist browser journey pass                                     | Continue invited-collector validation and triage reported issues       |
| 2026-09-13 | Post-MVP  | Fixed intermittent onboarding redirects after mutations: redirecting actions no longer force redundant revalidation, profile query errors no longer look like missing onboarding, established users bypass onboarding, and failures offer retry; 239 tests, build, and the authenticated deletion/onboarding/profile journey pass                            | Continue invited-collector validation and triage reported issues       |
| 2026-09-13 | Post-MVP  | Polished profile and wishlist form alignment: helper text no longer stretches neighboring controls, the primary Save action fills the left side beside a compact Preview action on desktop, and both stack at equal full width on phones; automated geometry checks pass in desktop Chromium, Android Chrome, and iPhone Safari                              | Continue invited-collector validation and triage reported issues       |
